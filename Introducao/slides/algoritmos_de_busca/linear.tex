...
\begin{frame}[fragile]{Implementação da busca sequencial}
    \inputsnippet{cpp}{1}{21}{codes/search.cpp}
\end{frame}
...
\begin{frame}[fragile]{Busca sequencial em C++}
    ...
    \begin{itemize}
        ...
        \item A assinatura da função \code{c++}{find()} é
            \inputsyntax{c++}{codes/find.st}
...
\begin{frame}[fragile]{Filtros em C++}
    ...
    \begin{itemize}
        ...
        \item A assinatura da função \code{c++}{copy_if()} é 
            \inputsyntax{c++}{codes/copy_if.st}
        ...
        \item O contêiner em questão deve implementar a função \code{c++}{push_back()}
...
\begin{frame}[fragile]{Transformações}
    ...
    \begin{itemize}
        ...
        \item A biblioteca \code{c++}{algorithm} do C++ implementa transformações através da
            função \code{c++}{transform()}

        \item A assinatura da função \code{c++}{transform()} é
            \inputsyntax{c++}{codes/transform.st}

        \item Há também uma versão da função \code{c++}{transform()} que aceita uma operação
            binária, cuja assinatura é
            \inputsyntax{c++}{codes/transform2.st}
