...
\begin{frame}[fragile]{Regras do ACM ICPC}
    ...
    \begin{itemize}
        ...
        técnico (\textit{coach})
        \item Os critérios de elegibilidade (2026) são:
            \begin{enumerate}
                \item ter participado, no máximo, de uma final mundial
                \item ter participado, no máximo, de 4 regionais
                \item ter iniciado seus estudos universitários em 2022 ou depois, \textbf{ou} 
                \item ter nascido em 2003 ou depois
            \end{enumerate}
...
\begin{frame}[fragile]{Campeões}
    ...
    Segundo a Wikipédia (2026),

    \begin{itemize}
        \item Os Estados Unidos detém o maior número de vitórias (18 no total)
        \item A Rússia é a atual campeã, com uma equipe da Universidade de São Petersburgo (5 no total)
        \item A Rússia tem 17 vitórias no total, e foi a campeã ininterrputa de 2012 a 2021 
        \item Os além dois já citados, os únicos países com mais de uma vitória no mundial são
            a China (6 vitórias), Polônia e Canadá (duas vitórias cada)
