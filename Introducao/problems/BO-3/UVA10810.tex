\section{UVA 10810 -- Ultra-QuickSort}
...
\begin{frame}[fragile]{Solução $O(N\log N)$}
    \inputsnippet{cpp}{1}{21}{10810.cpp}
\end{frame}

\begin{frame}[fragile]{Solução $O(N\log N)$}
    \inputsnippet{cpp}{22}{42}{10810.cpp}
\end{frame}

\begin{frame}[fragile]{Solução $O(N\log N)$}
    \inputsnippet{cpp}{43}{61}{10810.cpp}
\end{frame}

\begin{frame}[fragile]{Solução $O(N\log N)$}
    \inputsnippet{cpp}{62}{82}{10810.cpp}
\end{frame}
