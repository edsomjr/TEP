\section{OJ 100 -- The $3n + 1$ problem}
...
\begin{frame}[fragile]{Solução WA}
    \inputsnippet{cpp}{1}{21}{codes/OJ100_wa.cpp}
\end{frame}

\begin{frame}[fragile]{Solução WA}
    \inputsnippet{cpp}{22}{42}{codes/OJ100_wa.cpp}
\end{frame}
...
\begin{frame}[fragile]{Solução AC}
    \inputsnippet{cpp}{1}{21}{codes/OJ100_ac.cpp}
\end{frame}

\begin{frame}[fragile]{Solução AC}
    \inputsnippet{cpp}{22}{42}{codes/OJ100_ac.cpp}
\end{frame}
