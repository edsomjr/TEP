...
\begin{frame}[fragile]{Solução com complexidade $O(N + (M + K)\log (M + K))$}
    \inputsnippet{cpp}{1}{18}{codes/295A.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(N + (M + K)\log (M + K))$}
    \inputsnippet{cpp}{20}{39}{codes/295A.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(N + (M + K)\log (M + K))$}
    \inputsnippet{cpp}{41}{60}{codes/295A.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(N + (M + K)\log (M + K))$}
    \inputsnippet{cpp}{62}{79}{codes/295A.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(N + (M + K)\log (M + K))$}
    \inputsnippet{cpp}{81}{100}{codes/295A.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(N + (M + K)\log (M + K))$}
    \inputsnippet{cpp}{102}{125}{codes/295A.cpp}
\end{frame}
