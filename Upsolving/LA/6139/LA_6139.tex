...
\begin{frame}[fragile]{Solução com complexidade $O(K\log N + K)$}
    \inputsnippet{cpp}{1}{20}{codes/6139.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(K\log N + K)$}
    \inputsnippet{cpp}{22}{40}{codes/6139.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(K\log N + K)$}
    \inputsnippet{cpp}{42}{61}{codes/6139.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(K\log N + K)$}
    \inputsnippet{cpp}{63}{81}{codes/6139.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(K\log N + K)$}
    \inputsnippet{cpp}{83}{102}{codes/6139.cpp}
\end{frame}
