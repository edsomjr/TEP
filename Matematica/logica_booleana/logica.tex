...
\begin{frame}[fragile]{Lógica Booleana em C e C++}
    ...
    \begin{itemize}
        ...
        \item Importante notar que, embora a linguagem C++ tenha um tipo de dado booleano, ela interpreta como verdadeiro qualquer valor inteiro diferente de zero, e o zero como falso
    \end{itemize}
