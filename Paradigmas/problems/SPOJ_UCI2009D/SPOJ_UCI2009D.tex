...
\begin{frame}[fragile]{Solução}
    \inputsnippet{cpp}{1}{18}{codes/SPOJ_UCI2009D.cpp}
\end{frame}

\begin{frame}[fragile]{Solução}
    \inputsnippet{cpp}{20}{37}{codes/SPOJ_UCI2009D.cpp}
\end{frame}

\begin{frame}[fragile]{Solução}
    \inputsnippet{cpp}{39}{55}{codes/SPOJ_UCI2009D.cpp}
\end{frame}

\begin{frame}[fragile]{Solução}
    \inputsnippet{cpp}{57}{74}{codes/SPOJ_UCI2009D.cpp}
\end{frame}

\begin{frame}[fragile]{Solução}
    \inputsnippet{cpp}{76}{93}{codes/SPOJ_UCI2009D.cpp}
\end{frame}
