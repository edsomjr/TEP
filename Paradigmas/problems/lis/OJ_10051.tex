...
\begin{frame}[fragile]{Solução $O(TN^2)$}
    \inputsnippet{cpp}{1}{21}{codes/10051.cpp}
\end{frame}

\begin{frame}[fragile]{Solução $O(TN^2)$}
    \inputsnippet{cpp}{22}{42}{codes/10051.cpp}
\end{frame}

\begin{frame}[fragile]{Solução $O(TN^2)$}
    \inputsnippet{cpp}{43}{63}{codes/10051.cpp}
\end{frame}

\begin{frame}[fragile]{Solução $O(TN^2)$}
    \inputsnippet{cpp}{64}{84}{codes/10051.cpp}
\end{frame}
