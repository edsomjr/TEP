...
\begin{frame}[fragile]{Solução $O(N^3 + P^22^P)$}
    \inputsnippet{cpp}{1}{20}{codes/11284.cpp}
\end{frame}

\begin{frame}[fragile]{Solução $O(N^3 + P^22^P)$}
    \inputsnippet{cpp}{22}{41}{codes/11284.cpp}
\end{frame}

\begin{frame}[fragile]{Solução $O(N^3 + P^22^P)$}
    \inputsnippet{cpp}{43}{62}{codes/11284.cpp}
\end{frame}

\begin{frame}[fragile]{Solução $O(N^3 + P^22^P)$}
    \inputsnippet{cpp}{64}{82}{codes/11284.cpp}
\end{frame}

\begin{frame}[fragile]{Solução $O(N^3 + P^22^P)$}
    \inputsnippet{cpp}{84}{105}{codes/11284.cpp}
\end{frame}
