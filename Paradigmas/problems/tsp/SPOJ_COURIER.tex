...
\begin{frame}[fragile]{Solução $O(N^3 + K^22^K)$}
    \inputsnippet{cpp}{1}{20}{codes/COURIER.cpp}
\end{frame}

\begin{frame}[fragile]{Solução $O(N^3 + K^22^K)$}
    \inputsnippet{cpp}{21}{41}{codes/COURIER.cpp}
\end{frame}

\begin{frame}[fragile]{Solução $O(N^3 + K^22^K)$}
    \inputsnippet{cpp}{42}{62}{codes/COURIER.cpp}
\end{frame}

\begin{frame}[fragile]{Solução $O(N^3 + K^22^K)$}
    \inputsnippet{cpp}{64}{84}{codes/COURIER.cpp}
\end{frame}

\begin{frame}[fragile]{Solução $O(N^3 + K^22^K)$}
    \inputsnippet{cpp}{85}{105}{codes/COURIER.cpp}
\end{frame}
