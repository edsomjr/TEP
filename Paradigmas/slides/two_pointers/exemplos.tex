...
\begin{frame}[fragile]{Maior substring em ordem lexicográfica}
    ...
    \begin{itemize}
        \item Porém, é possível utilizar a técnica \textit{two pointeirs} neste problema
...
\begin{frame}[fragile]{Maior subvetor com, no máximo, $K$ números ímpares}
    ...
    \begin{itemize}
        \item Seja $\vec{v}$ um vetor com $N$ númerors inteiros
...
\begin{frame}[fragile]{Menor elemento em um subvetor de tamanho $K$}
    ...
    \begin{itemize}
        ...
        \item O problema de se deteminar o menor elemento de cada um dos $N - K + 1$ subintervalos
