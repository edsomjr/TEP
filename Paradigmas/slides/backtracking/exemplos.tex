...
\begin{frame}[fragile]{Listagem de subconjuntos usando {\it backtracking}}
    \inputsnippet{cpp}{1}{20}{codes/subsets.cpp}
\end{frame}

\begin{frame}[fragile]{Listagem de subconjuntos usando {\it backtracking}}
    \inputsnippet{cpp}{22}{41}{codes/subsets.cpp}
\end{frame}
...
\begin{frame}[fragile]{Listagem de permutações usando {\it backtracking}}
    \inputsnippet{cpp}{20}{33}{codes/permutacoes.cpp}
\end{frame}

\begin{frame}[fragile]{Listagem de permutações usando {\it backtracking}}
    \inputsnippet{cpp}{35}{50}{codes/permutacoes.cpp}
\end{frame}

\begin{frame}[fragile]{Listagem de permutações usando {\it backtracking}}
    \inputsnippet{cpp}{52}{70}{codes/permutacoes.cpp}
\end{frame}
...
\begin{frame}[fragile]{Listagem de combinações usando {\it backtracking}}
    \inputsnippet{cpp}{18}{31}{codes/combinacoes.cpp}
\end{frame}

\begin{frame}[fragile]{Listagem de combinações usando {\it backtracking}}
    \inputsnippet{cpp}{33}{48}{codes/combinacoes.cpp}
\end{frame}
