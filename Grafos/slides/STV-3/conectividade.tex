...
\begin{frame}[fragile]{Visualização da identificação dos componentes conectados}
    ...
    \begin{tikzpicture}
        ...
        \node[circle, draw, fill=white] at (6, 8) {5};
        \node[circle, draw, fill=white] at (6, 3) {6};
        \node[circle, draw, fill=green!30] at (8, 2) {7};
        \node[circle, draw, fill=blue!30] at (8, 7) {8};
        \node[circle, draw, fill=white] at (8, 5) {9};
        \node[circle, draw, fill=blue!30] at (10, 8) {10};
...
\begin{frame}[fragile]{Visualização da identificação dos componentes conectados}
    ...
    \begin{tikzpicture}
        ...
        \node[circle, draw, fill=blue!30] at (2, 9) {2};
        \node[circle, draw, fill=green!30] at (2, 2) {3};
        \node[circle, draw, fill=red!40] at (4, 4) {4};
        \node[circle, draw, fill=white] at (6, 8) {5};
        \node[circle, draw, fill=white] at (6, 3) {6};
        \node[circle, draw, fill=green!30] at (8, 2) {7};
        \node[circle, draw, fill=blue!30] at (8, 7) {8};
...
\begin{frame}[fragile]{Visualização da identificação dos componentes conectados}
    ...
    \begin{tikzpicture}
        ...
        \node[circle, draw, fill=green!30] at (2, 2) {3};
        \node[circle, draw, fill=red!40] at (4, 4) {4};
        \node[circle, draw, fill=red!40] at (6, 8) {5};
        \node[circle, draw, fill=white] at (6, 3) {6};
        \node[circle, draw, fill=green!30] at (8, 2) {7};
        \node[circle, draw, fill=blue!30] at (8, 7) {8};
        \node[circle, draw, fill=white] at (8, 5) {9};
...
\begin{frame}[fragile]{Visualização da identificação dos componentes conectados}
    ...
    \begin{tikzpicture}
        ...
        \node[circle, draw, fill=green!30] at (8, 2) {7};
        \node[circle, draw, fill=blue!30] at (8, 7) {8};
        \node[circle, draw, fill=red!40] at (8, 5) {9};
        \node[circle, draw, fill=blue!30] at (10, 8) {10};
...
\begin{frame}[fragile]{Visualização da identificação dos componentes conectados}
    ...
    \begin{tikzpicture}
        ...
        \node[circle, draw, fill=red!40] at (4, 4) {4};
        \node[circle, draw, fill=red!40] at (6, 8) {5};
        \node[circle, draw, fill=orange!40] at (6, 3) {6};
        \node[circle, draw, fill=green!30] at (8, 2) {7};
        \node[circle, draw, fill=blue!30] at (8, 7) {8};
        \node[circle, draw, fill=red!40] at (8, 5) {9};
        \node[circle, draw, fill=blue!30] at (10, 8) {10};
...
\begin{frame}[fragile]{Implementação da identificação dos componentes em C++}
    \inputsnippet{c++}{1}{21}{cc.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação da identificação dos componentes em C++}
    \inputsnippet{c++}{22}{41}{cc.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação da identificação dos componentes em C++}
    \inputsnippet{c++}{42}{62}{cc.cpp}
\end{frame}
