...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[anchor=west] (step1) at (1.0, 4.5) { $1.$ \bbtext{Marque todos os vértices $v\in V$ como não encontrado} };
	...
	\node[anchor=west] (step2b) at (2.0, 2.5) { $(b)$ \bbtext{Prossiga a travessia em todos seus filhos de $u$} };
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[anchor=west] (step2b) at (2.0, 2.5) { $(b)$ \bbtext{Exclua $u$ e todas as suas arestas que parte de $u$ do grafo $G$} };
