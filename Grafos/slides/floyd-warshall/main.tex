...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[anchor=west] (a) at (1.0, 5.0) { $\star$ \bbtext{Se $(u, v)$ atualizar $d[v]$, faça $\mathrm{pred}[v] = u$} };
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\draw[color=BBViolet,-latex,dashed](d) to [bend right] node[below right, pos=0.3] { \tiny $(\mathrm{prev}(\mbox{\bbtext{D}}), \mbox{\bbtext{D}})$ } (c);
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\draw[color=BBViolet,-latex,dashed](c) to [bend right] node[above right, pos=0.3] { \tiny $(\mathrm{prev}(\mbox{\bbtext{C}}), \mbox{\bbtext{C}})$ } (b);
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\draw[color=BBViolet,-latex,dashed](b) to [bend right] node[above left, pos=0.3] { \tiny $(\mathrm{prev}(\mbox{\bbtext{B}}), \mbox{\bbtext{B}})$ } (a);
