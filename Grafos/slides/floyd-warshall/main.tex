...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[] (title) at (1.0, 7.0) { \Large \bbbold{Proponentes} };
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[] (floyd) at (2.0, 4.0) { \includegraphics[scale=0.4]{figs/floyd.jpg} };

	\node[] (fname) at (2.0, 1.75) { \bbbold{Robert W. Floyd} };

	\node[] (fdate) at (2.0, 1.25) { \bbtext{(1962)} };
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[anchor=west] (title) at (0.0, 7.0) { \Large \bbbold{Características do algoritmo de Floyd-Warshall} };
\end{tikzpicture}
\end{frame}
\begin{frame}[plain,t]
\begin{tikzpicture}
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[anchor=west] (a1) at (1.0, 6.0) { $\star$ \bbtext{O algoritmo de Floyd-Warshall computa as distâncias mínimas, mas não os} };
