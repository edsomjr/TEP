...
\begin{frame}[fragile]{\textit{Breadth-First Search}}

    \begin{itemize}
        \item A travessia por largura (\textit{Breadth-First Search -- BFS}) visita os nós
            em ordem crescente em relação à distância ao nó inicial $s$

        \item Desta forma, um subproduto da BFS é a distância de todos os nós que conectados 
            até $s$
        ...
        \item Ambas travessias visitam os mesmos nós, porém em ordens diferentes
...
\begin{frame}[fragile]{Visualização da BFS}
    ...
    \begin{tikzpicture}
        \node[anchor=west] at (0,0) { Fila: 8 9 10 };
        \draw (0,4) -- (2,6);
        \draw (0,4) -- (2,2);
        \draw (2,6) -- (4,7);
        \draw (2,6) -- (4,5);
...
\begin{frame}[fragile]{Visualização da BFS}
    ...
    \begin{tikzpicture}
        \node[anchor=west] at (0,0) { Fila: 9 10 11 };
        \draw (0,4) -- (2,6);
        \draw (0,4) -- (2,2);
        \draw (2,6) -- (4,7);
        \draw (2,6) -- (4,5);
...
\begin{frame}[fragile]{Implementação da BFS em C++}
    \inputsnippet{c++}{1}{21}{bfs.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação da BFS em C++}
    \inputsnippet{c++}{22}{41}{bfs.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação da BFS em C++}
    \inputsnippet{c++}{42}{62}{bfs.cpp}
\end{frame}
