...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[anchor=west] (b1) at (1.5, 3.75) { \bbtext{$(a)$ Insera $u$ em $s$} };
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[anchor=west] (info) at (1.0, 5.5) { \bbtext{$(b)$ A lebre dá dois passos, a tartagura um, até se reencontrarem} };
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[anchor=west] (info) at (1.0, 5.5) { \bbtext{A tartagura andou $k$ passos e a lebre andou $2k$ passos} };
