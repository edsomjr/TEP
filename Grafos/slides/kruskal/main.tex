...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[anchor=west] (b) at (1.0, 5.0) { $\star$ \bbtext{Esta segunda melhor MST pode ser identificada por meio de uma nova} };

	\node[anchor=west] (b1) at (0.5, 4.5) { \bbtext{modificação no algoritmo de Kruskal} };
