...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[anchor=west] (a) at (1.0, 5.0) { $1.$ \bbtext{CSES 1750 -- Planet Queries I} };

	\node[anchor=west] (b) at (1.0, 4.0) { $2.$ \bbtext{CSES 1160 - Planty Queries II} };

	\node[anchor=west] (c) at (1.0, 3.0) { $3.$ \bbtext{USACO 2017 December Contest, Silver - Problem 3: The Bovine Shuffle} };
