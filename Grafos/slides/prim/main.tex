...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[anchor=west] (input) at (0.5, 6.0) { \bbemph{Entrada:} \bbtext{um grafo conectado ponderado $G(V, E)$} };
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[anchor=west] (a) at (1.0, 5.5) { $\star$ \bbtext{Uma MST minimiza o maior peso entre as arestas presentes em qualquer } };
