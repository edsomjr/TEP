...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[anchor=west] (info) at (1.0, 6.0) { \bbtext{A raiz não tem pai!} };
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[anchor=west] (info) at (1.0, 6.0) { \bbtext{O nível $l(u)$ do nó $u$ é igual ao número de nós no caminho de $u$ até a raiz} };
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\draw[color=BBViolet,thick,latex-] (7.75, 1.0) to  (8.5, 1.0);


	\node[anchor=east] (value) at (7.75, 1.0) { \footnotesize $l(1) = 3$ };
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[anchor=west] (info) at (1.0, 6.0) { \bbtext{A altura $h$ é igual ao máximo entre os níveis de todos os nós} };
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\draw[color=BBViolet,thick,latex-] (11.5, 5.0) to  (10.75, 5.0);


	\node[anchor=east] (value) at (10.75, 5.0) { \footnotesize $h = 3$ };
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[anchor=west] (info) at (1.0, 6.0) { \bbtext{Uma árvore com um único nó tem altura $1$} };
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[anchor=west] (info) at (1.0, 6.0) { \bbtext{Árvores vazias tem altura igual a zero} };
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[anchor=west] (title) at (0.0, 6.0) { \Large \bbbold{Definição formal de árvore} };
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[anchor=west] (line1) at (1.0, 5.0) { $1.$ \bbtext{Uma estrutura vazia é uma árvore} };
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[anchor=west] (line2) at (1.0, 4.0) { $2.$ \bbtext{Se $T_1, T_2, \ldots, T_k$ são árvores disjuntas, então a estrutura cuja raiz tem} };

	\node[anchor=west] (line2a) at (1.5, 3.5) { \bbtext{como filhos as raizes de $T_1, T_2, \ldots, T_k$ também é uma árvore} };
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[anchor=west] (line3) at (1.0, 2.5) { $3.$ \bbtext{Apenas estruturas geradas pelas regras $1$ e $2$ são árvores} };
