...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[draw,very thick,circle] (node4) at (13.5, 1.5) { \bbtext{4} };
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\draw[thick](node1) to node[above] { \footnotesize \bbinfo{212.13}} (node4);
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\draw[->,color=BBBlack,-latex,very thick] (1.85, 3.75) to  (1.85, 2.75);

	\node[] (r) at (1.85, 2.5) { \bbinfo{212.13} };
