...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[] (info) at (7.0, 6.0) { \bbtext{Considere um caminho entre a partida S e o destino D} };
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[draw,circle,very thick] (nodeS) at (2.0, 4.0) { \bbtext{S} };

	\node[draw,circle,very thick] (nodeA) at (5.0, 4.0) { \bbtext{A} };

	\node[draw,circle,very thick] (nodeB) at (9.0, 4.0) { \bbtext{B} };

	\node[draw,circle,very thick] (nodeC) at (7.0, 2.0) { \bbtext{C} };

	\node[draw,circle,very thick] (nodeD) at (12.0, 4.0) { \bbtext{D} };

	\draw[thick,color=BBCyan,very thick,dashed](nodeS) to node[above] { \footnotesize \bbinfo{40} } (nodeA);

	\draw[thick,color=BBCyan,very thick,dashed](nodeA) to node[above] { \footnotesize \bbinfo{10} } (nodeB);

	\draw[thick,color=BBCyan,very thick,dashed](nodeB) to node[above] { \footnotesize \bbinfo{50} } (nodeD);

	\draw[thick](nodeA) to node[above right] { \footnotesize \bbinfo{30} } (nodeC);

	\draw[thick](nodeC) to node[above left] { \footnotesize \bbinfo{20} } (nodeB);
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[] (info) at (7.0, 6.0) { \bbtext{O máximo de passageiros é determinado pela aresta de menor peso} };
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\draw[thick,color=BBCyan,very thick,dashed](nodeA) to node[above] { \footnotesize \textcolor{BBViolet}{\textbf{10}} } (nodeB);
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[] (info) at (7.0, 6.0) { \bbtext{O máximo é dado por este peso mínimo menos um, por conta do guia,} };
	...
	\node[] (info2) at (7.0, 5.5) { \bbtext{que ocupa uma posição no ônibus} };
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[] (info) at (7.0, 6.0) { \bbtext{O problema consiste em determinar o caminho de S a D que maximiza este peso } };
	...
	\draw[thick](nodeS) to node[above] { \footnotesize \bbinfo{40} } (nodeA);

	\draw[thick](nodeA) to node[above] { \footnotesize \bbinfo{10} } (nodeB);

	\draw[thick](nodeB) to node[above] { \footnotesize \bbinfo{50} } (nodeD);
	...
	\node[] (info2) at (7.0, 5.5) { \bbtext{mínimo, ou seja, um problema \bbenglish{maximin}} };
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\draw[thick,color=BBGreen,very thick,dashed](nodeS) to node[above] { \footnotesize \bbinfo{40} } (nodeA);

	\draw[thick](nodeA) to node[above] { \footnotesize \bbinfo{10} } (nodeB);

	\draw[thick,color=BBGreen,very thick,dashed](nodeB) to node[above] { \footnotesize \bbinfo{50} } (nodeD);

	\draw[thick,color=BBGreen,very thick,dashed](nodeA) to node[above right] { \footnotesize \bbinfo{30} } (nodeC);

	\draw[thick,color=BBGreen,very thick,dashed](nodeC) to node[above left] { \footnotesize \textcolor{BBViolet}{\textbf{20}} } (nodeB);
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[] (info) at (7.0, 6.0) { \bbtext{A MST resolve o problema \bbenglish{maximin}.} };
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[] (info) at (7.0, 6.0) { \bbtext{O algoritmo de Prim pode ser modificado para computar $\mathrm{maximin}($S$, u)$} };
	...
	\node[] (info2) at (7.0, 5.5) { \bbtext{para todos os vértices do componente conectado que contém $S$} };
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[] (info) at (7.0, 6.0) { \bbtext{Seja $u$ o próximo vértice a ser adicionado a $C$} };


	\node[draw,circle,very thick,fill=BBCyan] (nodeS) at (2.0, 4.0) { \bbtext{S} };
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[] (info) at (7.0, 6.0) { \bbtext{Se a aresta que conecta $u$ a $C$ é $(u, $ S$, w)$, então} };
	...
	\node[] (info2) at (7.0, 5.25) { $\displaystyle \mathrm{maximin}($\bbtext{S}$, u) = w$ };
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[draw,circle,very thick,fill=BBGreen] (nodeA) at (5.0, 4.0) { \bbtext{A} };
	...
	\draw[thick](nodeS) to node[above] { \footnotesize \textcolor{BBViolet}{\textbf{40}} } (nodeA);
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[] (info) at (7.0, 6.0) { \bbtext{Se a aresta que conecta $u$ a $C$ é $(u, v, w)$, então} };
	...
	\node[] (info2) at (7.0, 5.25) { $\displaystyle \mathrm{maximin}(S, u) = \min\ \{ \mathrm{maximin}($\bbtext{S}$, u), w) \}$ };
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[draw,circle,very thick,fill=BBOrange] (nodeC) at (7.0, 2.0) { \bbtext{C} };
	...
	\draw[thick](nodeA) to node[above right] { \footnotesize \textcolor{BBViolet}{\textbf{30}} } (nodeC);
