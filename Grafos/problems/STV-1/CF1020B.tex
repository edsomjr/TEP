\section{Codeforces Round \#503 (by SIS, Div. 2) -- Problem B: Badge}
...
\begin{frame}[fragile]{Solução AC com complexidade $O(N^2)$}
    \inputsnippet{cpp}{1}{21}{1020B.cpp}
\end{frame}

\begin{frame}[fragile]{Solução AC com complexidade $O(N^2)$}
    \inputsnippet{cpp}{22}{42}{1020B.cpp}
\end{frame}

\begin{frame}[fragile]{Solução AC com complexidade $O(N^2)$}
    \inputsnippet{cpp}{43}{63}{1020B.cpp}
\end{frame}
