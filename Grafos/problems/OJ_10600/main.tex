...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[] (r) at (1.25, 4.0) { \footnotesize \bbcomment{escola A} };
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[] (r) at (1.65, 4.0) { \footnotesize \bbcomment{escola B} };
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\draw[->,color=BBBlack,thick,-latex] (1.65, 1.75) to  (1.65, 0.75);

	\node[] (r) at (1.65, 0.5) { \footnotesize \bboutput{110 121} };
