...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[] (info) at (7.0, 2.0) { \bbtext{Considere $(x_p, y_p)$ e $(x_q, y_q)$ os pontos de partida e chegada, respectivamente.} };
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[] (info) at (7.0, 2.0) { \bbtext{Se foram dados $L$ passos para a esquerda e $R$ passos a direita, então} };
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[] (info) at (7.0, 2.0) { \bbtext{Se $L$ for minimizado, o valor de $R$ pode ser obtido por meio da expressão} };
