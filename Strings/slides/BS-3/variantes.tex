...
\begin{frame}[fragile]{Implementação do algoritmo de Rabin-Karp em Haskell}
    \inputsnippet{haskell}{1}{18}{rk2.hs}
\end{frame}

\begin{frame}[fragile]{Implementação do algoritmo de Rabin-Karp em Haskell}
    \inputsnippet{haskell}{19}{39}{rk2.hs}
\end{frame}

\begin{frame}[fragile]{Implementação do algoritmo de Rabin-Karp em C++}
    \inputsnippet{cpp}{1}{21}{rk2.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação do algoritmo de Rabin-Karp em C++}
    \inputsnippet{cpp}{22}{42}{rk2.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação do algoritmo de Rabin-Karp em C++}
    \inputsnippet{cpp}{43}{63}{rk2.cpp}
\end{frame}
...
\begin{frame}[fragile]{Implementação do algoritmo de Rabin-Karp em Haskell}
    \inputsnippet{haskell}{1}{18}{rk3.hs}
\end{frame}

\begin{frame}[fragile]{Implementação do algoritmo de Rabin-Karp em Haskell}
    \inputsnippet{haskell}{19}{39}{rk3.hs}
\end{frame}

\begin{frame}[fragile]{Implementação do algoritmo de Rabin-Karp em C++}
    \inputsnippet{cpp}{1}{21}{rk3.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação do algoritmo de Rabin-Karp em C++}
    \inputsnippet{cpp}{22}{42}{rk3.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação do algoritmo de Rabin-Karp em C++}
    \inputsnippet{cpp}{43}{63}{rk3.cpp}
\end{frame}
