...
\begin{frame}[fragile]{Implementação da busca em $O(m)$ em uma {\it trie}}
    \inputsnippet{cpp}{66}{81}{trie_naive.cpp}
\end{frame}
...
\begin{frame}[fragile]{Construção da {\it trie} com marcador}
    \inputsnippet{cpp}{83}{103}{trie_naive.cpp}
\end{frame}

\begin{frame}[fragile]{Construção da {\it trie} com marcador}
    \inputsnippet{cpp}{104}{117}{trie_naive.cpp}
\end{frame}

\begin{frame}[fragile]{Identificação das ocorrências de uma substring em uma {\it trie} com marcadores}
    \inputsnippet{cpp}{119}{136}{trie_naive.cpp}
\end{frame}

\begin{frame}[fragile]{Identificação das ocorrências de uma substring em uma {\it trie} com marcadores}
    \inputsnippet{cpp}{137}{152}{trie_naive.cpp}
\end{frame}
...
\begin{frame}[fragile]{Contagem de substrings distintas em uma {\it trie}}
    \inputsnippet{cpp}{154}{174}{trie_naive.cpp}
\end{frame}
