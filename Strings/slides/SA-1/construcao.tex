...
\begin{frame}[fragile]{Implementação do {\it counting sort}}
    \inputsnippet{cpp}{4}{23}{suffix_array.cpp}
\end{frame}

\begin{frame}[fragile]{Preenchimento das classes de equivalência}
    \inputsnippet{cpp}{25}{43}{suffix_array.cpp}
\end{frame}
...
\begin{frame}[fragile]{Implementação $O(N\log^2 N)$ do {\it suffix array}}
    \inputsnippet{cpp}{1}{21}{suffix_array_sort.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação $O(N\log^2 N)$ do {\it suffix array}}
    \inputsnippet{cpp}{22}{42}{suffix_array_sort.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação $O(N\log^2 N)$ do {\it suffix array}}
    \inputsnippet{cpp}{44}{64}{suffix_array_sort.cpp}
\end{frame}
...
\begin{frame}[fragile]{Implementação $O(N\log N)$ do {\it suffix array}}
    \inputsnippet{cpp}{1}{19}{suffix_array.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação $O(N\log N)$ do {\it suffix array}}
    \inputsnippet{cpp}{20}{40}{suffix_array.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação $O(N\log N)$ do {\it suffix array}}
    \inputsnippet{cpp}{41}{56}{suffix_array.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação $O(N\log N)$ do {\it suffix array}}
    \inputsnippet{cpp}{57}{77}{suffix_array.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação $O(N\log N)$ do {\it suffix array}}
    \inputsnippet{cpp}{79}{99}{suffix_array.cpp}
\end{frame}
