...
\begin{frame}[fragile]{Implementação {\it top-down} da LPS}
    \inputsnippet{cpp}{5}{25}{lps.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação {\it top-down} da LPS}
    \inputsnippet{cpp}{27}{47}{lps.cpp}
\end{frame}
...
\begin{frame}[fragile]{Implementação da identificação da LPS}
    \inputsnippet{cpp}{1}{21}{lps2.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação da identificação da LPS}
    \inputsnippet{cpp}{23}{43}{lps2.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação da identificação da LPS}
    \inputsnippet{cpp}{44}{64}{lps2.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação da identificação da LPS}
    \inputsnippet{cpp}{65}{85}{lps2.cpp}
\end{frame}
