...
\begin{frame}[fragile]{Reduções}
    ...
    \begin{itemize}
        ...
        \item Contudo, nem todos os compiladores implementaram a função \code{c}{reduce()}
            ainda
    \end{itemize}
...
\begin{frame}[fragile]{Implementação de uma redução usando laço e acumulador}
    \inputcode{cpp}{reduce_loop.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação de uma redução usando a função \code{c}{accumulate()}}
    \inputcode{cpp}{reduce.cpp}
\end{frame}
...
\begin{frame}[fragile]{Exemplo de uso de tabela de substituição}
    \inputsnippet{cpp}{1}{21}{table.cpp}
\end{frame}

\begin{frame}[fragile]{Exemplo de uso de tabela de substituição}
    \inputsnippet{cpp}{23}{43}{table.cpp}
\end{frame}

\begin{frame}[fragile]{Exemplo de uso de tabela de substituição}
    \inputsnippet{cpp}{44}{62}{table.cpp}
\end{frame}
