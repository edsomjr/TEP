...
\begin{frame}[fragile]{Teste de performance dos algoritmos de busca da STL}
    \inputsnippet{cpp}{1}{21}{search2.cpp}
\end{frame}

\begin{frame}[fragile]{Teste de performance dos algoritmos de busca da STL}
    \inputsnippet{cpp}{23}{43}{search2.cpp}
\end{frame}

\begin{frame}[fragile]{Teste de performance dos algoritmos de busca da STL}
    \inputsnippet{cpp}{44}{64}{search2.cpp}
\end{frame}
