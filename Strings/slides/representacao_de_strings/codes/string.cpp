...
int main()
{
    ...
    s = a.compare(0, 1, b); // s = 0, as strings são iguais no primeiro caractere
    s = a.compare(0, 2, b); // s > 0, "Te" sucede "TE" na ordem lexicográfica
    ...
    auto ll = stoll(a, NULL, 2);   // ll = 1099511627776, conversão em base binária
