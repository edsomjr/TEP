...
\begin{frame}[fragile]{Implementação de $edit(S, T)$ com memória $O(n)$}
    \inputsnippet{cpp}{1}{21}{edit2.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação de $edit(S, T)$ com memória $O(n)$}
    \inputsnippet{cpp}{22}{42}{edit2.cpp}
\end{frame}
...
\begin{frame}[fragile]{Implementação da sequência de operações ótima}
    \inputsnippet{cpp}{9}{29}{edit3.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação da sequência de operações ótima}
    \inputsnippet{cpp}{30}{50}{edit3.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação da sequência de operações ótima}
    \inputsnippet{cpp}{52}{72}{edit3.cpp}
\end{frame}
