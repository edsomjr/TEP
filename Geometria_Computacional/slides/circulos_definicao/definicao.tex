...
\begin{frame}[fragile]{Definição}
    ...
    \begin{itemize}
        ...
        \item A distância de um ponto do círculo ao seu centro $C$ é denominada raio $r$ 
        \pause

        \item Observe que a visualização do círculo depende da norma utilizada
        \pause

        \item A figura abaixo representa círculos com centro no ponto $(2, 1)$ e com raio $r = 3$
    ...
    \begin{center}
        \begin{tikzpicture}[scale=0.6]
            ...
            \matrix [draw,below left] at (17, 8) {
              ...
              \node [shape=circle, fill=red, label=right:Taxicab] {}; \\
              \node [shape=circle, fill=green, label=right:Máximo] {}; \\
            };
...
\begin{frame}[fragile]{Representação de círculos}
    ...
    \end{itemize}
        ...
        \inputcode{cpp}{codes/circle.cpp}
