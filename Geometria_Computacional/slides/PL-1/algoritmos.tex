...
\begin{frame}[fragile]{Perímetro}
    ...
    \inputsnippet{cpp}{43}{57}{polygon.cpp}
\end{frame}
...
\begin{frame}[fragile]{Implementação da área do polígono}
    \inputsnippet{cpp}{58}{71}{polygon.cpp}
\end{frame}
...
\begin{frame}[fragile]{Implementação da relação entre pontos e polígonos}
    \inputsnippet{cpp}{72}{90}{polygon.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação da relação entre pontos e polígonos}
    \inputsnippet{cpp}{91}{111}{polygon.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação da relação entre pontos e polígonos}
    \inputsnippet{cpp}{112}{124}{polygon.cpp}
\end{frame}
...
\begin{frame}[fragile]{Implementação da relação entre pontos e retas}
    \inputsnippet{cpp}{125}{145}{polygon.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação da relação entre pontos e retas}
    \inputsnippet{cpp}{147}{163}{polygon.cpp}
\end{frame}
...
\begin{frame}[fragile]{Implementação do cálculo do raio $R$ do círculo circunscrito}
    \inputsnippet{cpp}{164}{171}{polygon.cpp}
\end{frame}
...
\begin{frame}[fragile]{Implementação do cálculo do raio $r$ do círculo inscrito}
    \inputsnippet{cpp}{172}{178}{polygon.cpp}
\end{frame}
