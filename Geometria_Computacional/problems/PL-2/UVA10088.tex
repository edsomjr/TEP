\section{UVA 10088 -- Trees on My Island}
...
\begin{frame}[fragile]{Solução $O(TN)$}
    \inputsnippet{cpp}{1}{21}{10088.cpp}
\end{frame}

\begin{frame}[fragile]{Solução $O(TN)$}
    \inputsnippet{cpp}{22}{42}{10088.cpp}
\end{frame}

\begin{frame}[fragile]{Solução $O(TN)$}
    \inputsnippet{cpp}{43}{63}{10088.cpp}
\end{frame}

\begin{frame}[fragile]{Solução $O(TN)$}
    \inputsnippet{cpp}{64}{84}{10088.cpp}
\end{frame}
