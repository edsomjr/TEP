...
\begin{frame}[fragile]{Solução AC}
    \inputsnippet{cpp}{1}{21}{1C.cpp}
\end{frame}

\begin{frame}[fragile]{Solução AC}
    \inputsnippet{cpp}{22}{41}{1C.cpp}
\end{frame}

\begin{frame}[fragile]{Solução AC}
    \inputsnippet{cpp}{42}{60}{1C.cpp}
\end{frame}

\begin{frame}[fragile]{Solução AC}
    \inputsnippet{cpp}{61}{81}{1C.cpp}
\end{frame}

\begin{frame}[fragile]{Solução AC}
    \inputsnippet{cpp}{82}{102}{1C.cpp}
\end{frame}

\begin{frame}[fragile]{Solução AC}
    \inputsnippet{cpp}{103}{123}{1C.cpp}
\end{frame}

\begin{frame}[fragile]{Solução AC}
    \inputsnippet{cpp}{124}{144}{1C.cpp}
\end{frame}
