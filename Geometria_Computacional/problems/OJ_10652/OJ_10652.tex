\section{OJ 10652 -- Board Wrapping}
...
\begin{frame}[fragile]{Solução com complexidade $O(TN\log N)$}
    \inputsnippet{cpp}{1}{19}{10652.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(TN\log N)$}
    \inputsnippet{cpp}{21}{35}{10652.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(TN\log N)$}
    \inputsnippet{cpp}{37}{55}{10652.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(TN\log N)$}
    \inputsnippet{cpp}{57}{75}{10652.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(TN\log N)$}
    \inputsnippet{cpp}{76}{95}{10652.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(TN\log N)$}
    \inputsnippet{cpp}{97}{116}{10652.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(TN\log N)$}
    \inputsnippet{cpp}{118}{137}{10652.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(TN\log N)$}
    \inputsnippet{cpp}{139}{158}{10652.cpp}
\end{frame}
