...
\begin{frame}[fragile]{Solução AC com complexidade $O(1)$}
    \inputsnippet{cpp}{1}{21}{2C.cpp}
\end{frame}

\begin{frame}[fragile]{Solução AC com complexidade $O(1)$}
    \inputsnippet{cpp}{22}{42}{2C.cpp}
\end{frame}

\begin{frame}[fragile]{Solução AC com complexidade $O(1)$}
    \inputsnippet{cpp}{43}{63}{2C.cpp}
\end{frame}

\begin{frame}[fragile]{Solução AC com complexidade $O(1)$}
    \inputsnippet{cpp}{64}{84}{2C.cpp}
\end{frame}

\begin{frame}[fragile]{Solução AC com complexidade $O(1)$}
    \inputsnippet{cpp}{85}{105}{2C.cpp}
\end{frame}

\begin{frame}[fragile]{Solução AC com complexidade $O(1)$}
    \inputsnippet{cpp}{106}{126}{2C.cpp}
\end{frame}

\begin{frame}[fragile]{Solução AC com complexidade $O(1)$}
    \inputsnippet{cpp}{127}{146}{2C.cpp}
\end{frame}

\begin{frame}[fragile]{Solução AC com complexidade $O(1)$}
    \inputsnippet{cpp}{147}{167}{2C.cpp}
\end{frame}
