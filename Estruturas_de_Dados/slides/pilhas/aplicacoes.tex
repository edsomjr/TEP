...
\begin{frame}[fragile]{Exemplo de identificação de delimitadores}
    \inputsnippet{c++}{1}{20}{codes/delimitadores.cpp}
\end{frame}
...
\begin{frame}[fragile]{Exemplo de adição de grandes números}
    \inputsnippet{c++}{1}{21}{codes/bigint.cpp}
\end{frame}

\begin{frame}[fragile]{Exemplo de adição de grandes números}
    \inputsnippet{c++}{23}{43}{codes/bigint.cpp}
\end{frame}

\begin{frame}[fragile]{Exemplo de adição de grandes números}
    \inputsnippet{c++}{44}{64}{codes/bigint.cpp}
\end{frame}
