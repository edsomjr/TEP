...
\begin{frame}[fragile]{Min heap na STL}
    ...
    \begin{itemize}
        ...
        \item A segunda maneira é utilizar a função \code{c}{greater()} da STL, a qual inverte
            o operator \code{c}{<} que é utilizado por padrão
...
\begin{frame}[fragile]{Exemplo de min heap na STL}
    \inputsnippet{cpp}{1}{21}{min.cpp}
\end{frame}

\begin{frame}[fragile]{Exemplo de min heap na STL}
    \inputsnippet{cpp}{22}{42}{min.cpp}
\end{frame}
