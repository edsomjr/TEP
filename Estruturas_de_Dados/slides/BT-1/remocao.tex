...
\begin{frame}[fragile]{Implementação da remoção em uma árvore-B}
    \inputsnippet{cpp}{194}{211}{btree.cpp}
\end{frame}
...
\begin{frame}[fragile]{Implementação da remoção em uma árvore-B}
    \inputsnippet{cpp}{232}{252}{btree.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação da remoção em uma árvore-B}
    \inputsnippet{cpp}{254}{273}{btree.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação da remoção em uma árvore-B}
    \inputsnippet{cpp}{274}{293}{btree.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação da remoção em uma árvore-B}
            \inputsnippet{cpp}{294}{304}{btree.cpp}
\end{frame}
