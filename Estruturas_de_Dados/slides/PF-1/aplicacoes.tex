...
\begin{frame}[fragile]{Identificação de delimitadores}
    ...
    \begin{itemize}
        ...
        \item Em C++, os caracteres \code{c}{(), [], {}, /*  */} são delimitadores
...
\begin{frame}[fragile]{Exemplo de identificação de delimitadores}
    \inputsnippet{c++}{1}{20}{delimitadores.cpp}
\end{frame}

\begin{frame}[fragile]{Exemplo de identificação de delimitadores}
    \inputsnippet{c++}{21}{41}{delimitadores.cpp}
\end{frame}
...
\begin{frame}[fragile]{Exemplo de adição de grandes números}
    \inputsnippet{c++}{1}{21}{bigint.cpp}
\end{frame}

\begin{frame}[fragile]{Exemplo de adição de grandes números}
    \inputsnippet{c++}{23}{43}{bigint.cpp}
\end{frame}

\begin{frame}[fragile]{Exemplo de adição de grandes números}
    \inputsnippet{c++}{44}{64}{bigint.cpp}
\end{frame}
