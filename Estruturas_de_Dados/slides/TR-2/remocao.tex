...
\begin{frame}[fragile]{Implementação da remoção por fusão}
    \inputsnippet{cpp}{21}{36}{delete_by_merging.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação da remoção por fusão}
    \inputsnippet{cpp}{37}{57}{delete_by_merging.cpp}
\end{frame}
...
\begin{frame}[fragile]{Exemplo de remoção por cópia}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}{shift={(3,1)}}
            ...
            \node[circle,draw,fill=blue!30] (D) at (4, 5) { $23$ };
            \node[circle,draw,fill=gray!30] (C) at (2, 3) { $9$ };
            \node[circle,draw] (E) at (6, 3) { $63$ };
            \node[circle,draw] (F) at (5, 1) { $47$ };
            \node[circle,draw] (A) at (1, 1) { $1$ };
            \node[circle,draw,fill=red!30] (B) at (3, 1) { $25$ };
            \node[circle,draw] (G) at (7, 1) { $80$ };
            \node[circle,draw] (H) at (2, -1) { $14$ };
...
\begin{frame}[fragile]{Implementação da remoção por cópia}
    \inputsnippet{cpp}{1}{20}{delete_by_copying.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação da remoção por cópia}
    \inputsnippet{cpp}{21}{36}{delete_by_copying.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação da remoção por cópia}
    \inputsnippet{cpp}{37}{57}{delete_by_copying.cpp}
\end{frame}
