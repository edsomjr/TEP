...
\begin{frame}[fragile]{Remoção em árvores-B}
	...
	\begin{enumerate}
		...
		\begin{enumerate}
			...
			\begin{enumerate}
				\item Se o irmão à direita ou à esquerda possui mais do que $M$ chaves,
...
\begin{frame}[fragile]{Exemplo de remoção no caso 1.1, $m = 4$}
    ...
    \begin{tikzpicture}
        \begin{scope}
            \node[opacity=0] at (-0.5, -0.5) { } ;
            \node[anchor=west] at (1, 6.0) { Elemento a ser removido: \textcolor{blue}{99} };
            ...
            \node at (6.25, 0.25) { \footnotesize \textcolor{black}{67} };

            \node at (8.25, 0.25) { \footnotesize \textcolor{black}{92} };
            \node at (8.75, 0.25) { \footnotesize \textcolor{blue}{99} };
...
\begin{frame}[fragile]{Exemplo de remoção no caso 1.1, $m = 4$}
    ...
    \begin{tikzpicture}
        \begin{scope}
            \node[opacity=0] at (-0.5, -0.5) { } ;
            \node[anchor=west] at (1, 6.0) { Elemento a ser removido: \textcolor{black}{99} };
...
\input{erase_special_case}

\begin{frame}[fragile]{Implementação da remoção em uma árvore-B}
    \inputsnippet{cpp}{150}{169}{btree.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação da remoção em uma árvore-B}
    \inputsnippet{cpp}{171}{190}{btree.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação da remoção em uma árvore-B}
    \inputsnippet{cpp}{192}{211}{btree.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação da remoção em uma árvore-B}
    \inputsnippet{cpp}{212}{231}{btree.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação da remoção em uma árvore-B}
    \inputsnippet{cpp}{232}{251}{btree.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação da remoção em uma árvore-B}
    \inputsnippet{cpp}{253}{271}{btree.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação da remoção em uma árvore-B}
    \inputsnippet{cpp}{273}{289}{btree.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação da remoção em uma árvore-B}
            \inputsnippet{cpp}{291}{295}{btree.cpp}
\end{frame}
