\begin{frame}{Exemplo de inserção utilizando sondagem quadrática} 
    ...
    \begin{figure}
        \begin{tikzpicture}
            ...
            \node[anchor=west] at (1, 6) { Sondagem quadrática, $T = 11$ };
...
\begin{frame}{Exemplo de inserção utilizando sondagem quadrática} 
    ...
    \begin{figure}
        \begin{tikzpicture}
            ...
            \node[anchor=west] at (2, 4.5) { $N(h(-6) + 1^2) = (5 + 1)\ (\mbox{mod}\ 11) = 6$ };
...
\begin{frame}{Exemplo de inserção utilizando sondagem quadrática} 
    ...
    \begin{figure}
        \begin{tikzpicture}
            ...
            \node[anchor=west] at (2, 4.5) { $N(h(49) + 1^2) = (5 + 1)\ (\mbox{mod}\ 11) = 6$ };
...
\begin{frame}{Exemplo de inserção utilizando sondagem quadrática} 
    ...
    \begin{figure}
        \begin{tikzpicture}
            ...
            \node[anchor=west] at (2, 4.5) { $N(h(49) - 1^2) = (5 - 1)\ (\mbox{mod}\ 11) = 4$ };

            \node at (2.5, 1.5) { \textcolor{black}{$35$} };
            \node at (4.5, 1.5) { \textcolor{black}{$49$} };
            \node at (5.5, 1.5) { \textcolor{black}{$16$} };
            \node at (6.5, 1.5) { \textcolor{black}{$-6$} };
            \node at (7.5, 1.5) { \textcolor{black}{$51$} };
            \node at (10.5, 1.5) { \textcolor{black}{$76$} };
