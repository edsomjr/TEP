...
\begin{frame}[fragile]{Implementação das funções \rawcode{pop\_back()} e \rawcode{clear()}}
    \inputsnippet{c}{108}{128}{vector_adt.c}
\end{frame}
...
\begin{frame}[fragile]{Implementação da função \rawcode{pop}}
    \inputsnippet{c}{130}{150}{vector_adt.c}
\end{frame}

\begin{frame}[fragile]{Exemplo de remoção em posição arbitrária}
    \inputsnippet{c}{1}{21}{passageiros2.c}
\end{frame}

\begin{frame}[fragile]{Exemplo de remoção em posição arbitrária}
    \inputsnippet{c}{23}{43}{passageiros2.c}
\end{frame}

\begin{frame}[fragile]{Exemplo de remoção em posição arbitrária}
    \inputsnippet{c}{44}{64}{passageiros2.c}
\end{frame}

\begin{frame}[fragile]{Exemplo de remoção em posição arbitrária}
    \inputsnippet{c}{65}{85}{passageiros2.c}
\end{frame}
