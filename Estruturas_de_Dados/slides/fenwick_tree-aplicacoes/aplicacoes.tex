...
\begin{frame}[fragile]{Implementação de uma árvore de Fenwick para produtos}
    \inputsnippet{cpp}{1}{20}{codes/product_bit_tree.h}
\end{frame}

\begin{frame}[fragile]{Implementação de uma árvore de Fenwick para produtos}
    \inputsnippet{cpp}{21}{41}{codes/product_bit_tree.h}
\end{frame}

\begin{frame}[fragile]{Implementação de uma árvore de Fenwick para produtos}
    \inputsnippet{cpp}{43}{60}{codes/product_bit_tree.h}
\end{frame}

\begin{frame}[fragile]{Implementação de uma árvore de Fenwick para produtos}
    \inputsnippet{cpp}{61}{81}{codes/product_bit_tree.h}
\end{frame}
