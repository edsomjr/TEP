...
\begin{frame}[fragile]{Implementação da {\it lazy propagation}}
    \inputsnippet{cpp}{1}{19}{codes/segtree_lazy.h}
\end{frame}

\begin{frame}[fragile]{Implementação da {\it lazy propagation}}
    \inputsnippet{cpp}{21}{40}{codes/segtree_lazy.h}
\end{frame}

\begin{frame}[fragile]{Implementação da {\it lazy propagation}}
    \inputsnippet{cpp}{42}{61}{codes/segtree_lazy.h}
\end{frame}

\begin{frame}[fragile]{Implementação da {\it lazy propagation}}
    \inputsnippet{cpp}{63}{82}{codes/segtree_lazy.h}
\end{frame}

\begin{frame}[fragile]{Implementação da {\it lazy propagation}}
    \inputsnippet{cpp}{84}{105}{codes/segtree_lazy.h}
\end{frame}
