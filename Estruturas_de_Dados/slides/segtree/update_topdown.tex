\begin{frame}[fragile]{Visualização de update(3, -2)}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}
            ...
            \node[draw,ultra thick,circle] (A4) at (4, 0) { 4 };
...
\begin{frame}[fragile]{Visualização de update(3, -2)}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}
            ...
            \node[draw,circle,fill=red!30] (C2) at (6.5, 4) { 26 };
...
\begin{frame}[fragile]{Visualização de update(3, -2)}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}
            ...
            \node[draw,circle,fill=green!90!black] (B2) at (3.5, 2) { 7 };
            \node[draw,circle,fill=gray!20] (B3) at (5.5, 2) { 11 };
            \node[draw,circle,fill=gray!20] (B4) at (7.5, 2) { 15 };
            ...
            \node[draw,circle,fill=gray!20] (D1) at (4.5, 6) { 34 };
...
\begin{frame}[fragile]{Visualização de update(3, -2)}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}
            \node[draw,circle] (A1) at (1, 0) { 1 };
            \node[draw,circle] (A2) at (2, 0) { 2 };
            \node[draw,circle,fill=red!30] (A3) at (3, 0) { 3 };
            \node[draw,ultra thick,circle,fill=green!90!black] (A4) at (4, 0) { 4 };
            \node[draw,circle] (A5) at (5, 0) { 5 };
            \node[draw,circle] (A6) at (6, 0) { 6 };
            \node[draw,circle] (A7) at (7, 0) { 7 };
            \node[draw,circle] (A8) at (8, 0) { 8 };
