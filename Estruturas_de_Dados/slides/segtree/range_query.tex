...
\begin{frame}[fragile]{Visualização de RSQ(2, 6)}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}
            ...
            \node[anchor=west] at (2, 2) { \footnotesize \tt [0,1] };

            \node[draw,circle,fill=blue!30] (B2) at (3.5, 2) { 7 };
            \node[anchor=west] at (4, 2) { \footnotesize \tt [2,3] };

            \node[draw,circle,fill=blue!30] (B3) at (5.5, 2) { 11 };
            \node[anchor=west] at (6, 2) { \footnotesize \tt [4,5] };

            \node[draw,circle,fill=green!90!black] (B4) at (7.5, 2) { 15 };
            \node[anchor=west] at (8, 2) { \footnotesize \tt [6,7] };
