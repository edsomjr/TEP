...
\begin{frame}[fragile]{Anexar ao final do vetor}
    ...
    \begin{itemize}
        ...
        indicado na posição correspondente e atualizar o campo \rawcode{size}
...
\begin{frame}[fragile]{Implementação da função \rawcode{push\_back()}}
    \inputsnippet{c}{64}{84}{codes/vector_adt.c}
\end{frame}
...
\begin{frame}[fragile]{Implementação da função \rawcode{push()}}
    \inputsnippet{c}{86}{106}{codes/vector_adt.c}
\end{frame}

\begin{frame}[fragile]{Exemplo de inserções}
    \inputsnippet{c}{1}{21}{codes/passageiros.c}
\end{frame}

\begin{frame}[fragile]{Exemplo de inserções}
    \inputsnippet{c}{22}{41}{codes/passageiros.c}
\end{frame}
