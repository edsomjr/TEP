...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            ...
            \node[circle,draw,fill=blue!30] (A) at (6.75, 5) { $13$ };
            \node[circle,draw] (B) at (4.25, 3) { $10$ };
            \node[circle,draw] (C) at (9.75, 3) { $25$ };
            \node[circle,draw] (D) at (2.75, 1) { $5$ };
            \node[circle,draw] (E) at (5.75, 1) { $12$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            ...
            \node[circle,draw,fill=blue!30] (A) at (6.75, 5) { $13$ };
            \node[circle,draw,fill=green!30] (B) at (4.25, 3) { $10$ };
            \node[circle,draw] (C) at (9.75, 3) { $25$ };
            \node[circle,draw] (D) at (2.75, 1) { $5$ };
            \node[circle,draw] (E) at (5.75, 1) { $12$ };
            \node[circle,draw] (F) at (8.25, 1) { $20$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            ...
            \node[circle,draw,fill=blue!30] (A) at (6.75, 5) { $13$ };
            \node[circle,draw,fill=blue!30] (B) at (4.25, 3) { $10$ };
            \node[circle,draw] (C) at (9.75, 3) { $25$ };
            \node[circle,draw] (D) at (2.75, 1) { $5$ };
            \node[circle,draw] (E) at (5.75, 1) { $12$ };
            \node[circle,draw] (F) at (8.25, 1) { $20$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            ...
            \node[circle,draw,fill=blue!30] (B) at (4.25, 3) { $10$ };
            \node[circle,draw] (C) at (9.75, 3) { $25$ };
            \node[circle,draw,fill=green!30] (D) at (2.75, 1) { $5$ };
            \node[circle,draw] (E) at (5.75, 1) { $12$ };
            \node[circle,draw] (F) at (8.25, 1) { $20$ };
            \node[circle,draw] (G) at (11.25, 1) { $31$ };
            \node[circle,draw] (H) at (2, -1) { $1$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            ...
            \node[circle,draw,fill=blue!30] (B) at (4.25, 3) { $10$ };
            \node[circle,draw] (C) at (9.75, 3) { $25$ };
            \node[circle,draw,fill=blue!30] (D) at (2.75, 1) { $5$ };
            \node[circle,draw] (E) at (5.75, 1) { $12$ };
            \node[circle,draw] (F) at (8.25, 1) { $20$ };
            \node[circle,draw] (G) at (11.25, 1) { $31$ };
            \node[circle,draw] (H) at (2, -1) { $1$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            ...
            \node[circle,draw] (F) at (8.25, 1) { $20$ };
            \node[circle,draw] (G) at (11.25, 1) { $31$ };
            \node[circle,draw,fill=green!30] (H) at (2, -1) { $1$ };
            \node[circle,draw] (I) at (3.5, -1) { $6$ };
            \node[circle,draw] (J) at (5, -1) { $11$ };
            \node[circle,draw] (L) at (7.5, -1) { $18$ };
            \node[circle,draw] (M) at (9, -1) { $22$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            ...
            \node[circle,draw] (F) at (8.25, 1) { $20$ };
            \node[circle,draw] (G) at (11.25, 1) { $31$ };
            \node[circle,draw,fill=blue!30] (H) at (2, -1) { $1$ };
            \node[circle,draw] (I) at (3.5, -1) { $6$ };
            \node[circle,draw] (J) at (5, -1) { $11$ };
            \node[circle,draw] (L) at (7.5, -1) { $18$ };
            \node[circle,draw] (M) at (9, -1) { $22$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            ...
            \node[circle,draw] (F) at (8.25, 1) { $20$ };
            \node[circle,draw] (G) at (11.25, 1) { $31$ };
            \node[circle,draw,fill=gray!30] (H) at (2, -1) { $1$ };
            \node[circle,draw] (I) at (3.5, -1) { $6$ };
            \node[circle,draw] (J) at (5, -1) { $11$ };
            \node[circle,draw] (L) at (7.5, -1) { $18$ };
            \node[circle,draw] (M) at (9, -1) { $22$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            ...
            \node[circle,draw,fill=blue!30] (B) at (4.25, 3) { $10$ };
            \node[circle,draw] (C) at (9.75, 3) { $25$ };
            \node[circle,draw,fill=red!30] (D) at (2.75, 1) { $5$ };
            \node[circle,draw] (E) at (5.75, 1) { $12$ };
            \node[circle,draw] (F) at (8.25, 1) { $20$ };
            \node[circle,draw] (G) at (11.25, 1) { $31$ };
            \node[circle,draw,fill=gray!30] (H) at (2, -1) { $1$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            ...
            \node[circle,draw,fill=blue!30] (B) at (4.25, 3) { $10$ };
            \node[circle,draw] (C) at (9.75, 3) { $25$ };
            \node[circle,draw,fill=gray!30] (D) at (2.75, 1) { $5$ };
            \node[circle,draw] (E) at (5.75, 1) { $12$ };
            \node[circle,draw] (F) at (8.25, 1) { $20$ };
            \node[circle,draw] (G) at (11.25, 1) { $31$ };
            \node[circle,draw,fill=gray!30] (H) at (2, -1) { $1$ };
            \node[circle,draw,fill=green!30] (I) at (3.5, -1) { $6$ };
            \node[circle,draw] (J) at (5, -1) { $11$ };
            \node[circle,draw] (L) at (7.5, -1) { $18$ };
            \node[circle,draw] (M) at (9, -1) { $22$ };
            \node[circle,draw] (N) at (10.5, -1) { $29$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            \node[anchor=west] (X) at (0, 6) { Travessia pré-ordem: 13, 10, 5, 1, \textcolor{blue}{6} };
            ...
            \node[circle,draw] (G) at (11.25, 1) { $31$ };
            \node[circle,draw,fill=gray!30] (H) at (2, -1) { $1$ };
            \node[circle,draw,fill=blue!30] (I) at (3.5, -1) { $6$ };
            \node[circle,draw] (J) at (5, -1) { $11$ };
            \node[circle,draw] (L) at (7.5, -1) { $18$ };
            \node[circle,draw] (M) at (9, -1) { $22$ };
            \node[circle,draw] (N) at (10.5, -1) { $29$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            \node[anchor=west] (X) at (0, 6) { Travessia pré-ordem: 13, 10, 5, 1, 6\textcolor{blue}{} };
            ...
            \node[circle,draw] (G) at (11.25, 1) { $31$ };
            \node[circle,draw,fill=gray!30] (H) at (2, -1) { $1$ };
            \node[circle,draw,fill=gray!30] (I) at (3.5, -1) { $6$ };
            \node[circle,draw] (J) at (5, -1) { $11$ };
            \node[circle,draw] (L) at (7.5, -1) { $18$ };
            \node[circle,draw] (M) at (9, -1) { $22$ };
            \node[circle,draw] (N) at (10.5, -1) { $29$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            ...
            \node[circle,draw,fill=blue!30] (A) at (6.75, 5) { $13$ };
            \node[circle,draw,fill=red!30] (B) at (4.25, 3) { $10$ };
            \node[circle,draw] (C) at (9.75, 3) { $25$ };
            \node[circle,draw,fill=gray!30] (D) at (2.75, 1) { $5$ };
            \node[circle,draw] (E) at (5.75, 1) { $12$ };
            \node[circle,draw] (F) at (8.25, 1) { $20$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            ...
            \node[circle,draw,fill=blue!30] (A) at (6.75, 5) { $13$ };
            \node[circle,draw,fill=gray!30] (B) at (4.25, 3) { $10$ };
            \node[circle,draw] (C) at (9.75, 3) { $25$ };
            \node[circle,draw,fill=gray!30] (D) at (2.75, 1) { $5$ };
            \node[circle,draw,fill=green!30] (E) at (5.75, 1) { $12$ };
            \node[circle,draw] (F) at (8.25, 1) { $20$ };
            \node[circle,draw] (G) at (11.25, 1) { $31$ };
            \node[circle,draw,fill=gray!30] (H) at (2, -1) { $1$ };
            \node[circle,draw,fill=gray!30] (I) at (3.5, -1) { $6$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            \node[anchor=west] (X) at (0, 6) { Travessia pré-ordem: 13, 10, 5, 1, 6, \textcolor{blue}{12} };
            \node[circle,draw,fill=blue!30] (A) at (6.75, 5) { $13$ };
            \node[circle,draw,fill=gray!30] (B) at (4.25, 3) { $10$ };
            \node[circle,draw] (C) at (9.75, 3) { $25$ };
            \node[circle,draw,fill=gray!30] (D) at (2.75, 1) { $5$ };
            \node[circle,draw,fill=blue!30] (E) at (5.75, 1) { $12$ };
            \node[circle,draw] (F) at (8.25, 1) { $20$ };
            \node[circle,draw] (G) at (11.25, 1) { $31$ };
            \node[circle,draw,fill=gray!30] (H) at (2, -1) { $1$ };
            \node[circle,draw,fill=gray!30] (I) at (3.5, -1) { $6$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            \node[anchor=west] (X) at (0, 6) { Travessia pré-ordem: 13, 10, 5, 1, 6, 12\textcolor{blue}{} };
            \node[circle,draw,fill=blue!30] (A) at (6.75, 5) { $13$ };
            \node[circle,draw,fill=gray!30] (B) at (4.25, 3) { $10$ };
            \node[circle,draw] (C) at (9.75, 3) { $25$ };
            \node[circle,draw,fill=gray!30] (D) at (2.75, 1) { $5$ };
            ...
            \node[circle,draw,fill=gray!30] (H) at (2, -1) { $1$ };
            \node[circle,draw,fill=gray!30] (I) at (3.5, -1) { $6$ };
            \node[circle,draw,fill=green!30] (J) at (5, -1) { $11$ };
            \node[circle,draw] (L) at (7.5, -1) { $18$ };
            \node[circle,draw] (M) at (9, -1) { $22$ };
            \node[circle,draw] (N) at (10.5, -1) { $29$ };
            \node[circle,draw] (O) at (12, -1) { $45$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            \node[anchor=west] (X) at (0, 6) { Travessia pré-ordem: 13, 10, 5, 1, 6, 12, \textcolor{blue}{11} };
            \node[circle,draw,fill=blue!30] (A) at (6.75, 5) { $13$ };
            \node[circle,draw,fill=gray!30] (B) at (4.25, 3) { $10$ };
            \node[circle,draw] (C) at (9.75, 3) { $25$ };
            \node[circle,draw,fill=gray!30] (D) at (2.75, 1) { $5$ };
            ...
            \node[circle,draw,fill=gray!30] (H) at (2, -1) { $1$ };
            \node[circle,draw,fill=gray!30] (I) at (3.5, -1) { $6$ };
            \node[circle,draw,fill=blue!30] (J) at (5, -1) { $11$ };
            \node[circle,draw] (L) at (7.5, -1) { $18$ };
            \node[circle,draw] (M) at (9, -1) { $22$ };
            \node[circle,draw] (N) at (10.5, -1) { $29$ };
            \node[circle,draw] (O) at (12, -1) { $45$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            \node[anchor=west] (X) at (0, 6) { Travessia pré-ordem: 13, 10, 5, 1, 6, 12, 11\textcolor{blue}{} };
            \node[circle,draw,fill=blue!30] (A) at (6.75, 5) { $13$ };
            \node[circle,draw,fill=gray!30] (B) at (4.25, 3) { $10$ };
            \node[circle,draw] (C) at (9.75, 3) { $25$ };
            \node[circle,draw,fill=gray!30] (D) at (2.75, 1) { $5$ };
            ...
            \node[circle,draw,fill=gray!30] (H) at (2, -1) { $1$ };
            \node[circle,draw,fill=gray!30] (I) at (3.5, -1) { $6$ };
            \node[circle,draw,fill=gray!30] (J) at (5, -1) { $11$ };
            \node[circle,draw] (L) at (7.5, -1) { $18$ };
            \node[circle,draw] (M) at (9, -1) { $22$ };
            \node[circle,draw] (N) at (10.5, -1) { $29$ };
            \node[circle,draw] (O) at (12, -1) { $45$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            ...
            \node[circle,draw] (C) at (9.75, 3) { $25$ };
            \node[circle,draw,fill=gray!30] (D) at (2.75, 1) { $5$ };
            \node[circle,draw,fill=red!30] (E) at (5.75, 1) { $12$ };
            \node[circle,draw] (F) at (8.25, 1) { $20$ };
            \node[circle,draw] (G) at (11.25, 1) { $31$ };
            \node[circle,draw,fill=gray!30] (H) at (2, -1) { $1$ };
            \node[circle,draw,fill=gray!30] (I) at (3.5, -1) { $6$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            \node[anchor=west] (X) at (0, 6) { Travessia pré-ordem: 13, 10, 5, 1, 6, 12, 11\textcolor{blue}{} };
            \node[circle,draw,fill=red!30] (A) at (6.75, 5) { $13$ };
            \node[circle,draw,fill=gray!30] (B) at (4.25, 3) { $10$ };
            \node[circle,draw] (C) at (9.75, 3) { $25$ };
            \node[circle,draw,fill=gray!30] (D) at (2.75, 1) { $5$ };
            \node[circle,draw,fill=gray!30] (E) at (5.75, 1) { $12$ };
            \node[circle,draw] (F) at (8.25, 1) { $20$ };
            \node[circle,draw] (G) at (11.25, 1) { $31$ };
            \node[circle,draw,fill=gray!30] (H) at (2, -1) { $1$ };
            \node[circle,draw,fill=gray!30] (I) at (3.5, -1) { $6$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            ...
            \node[circle,draw,fill=gray!30] (B) at (4.25, 3) { $10$ };
            \node[circle,draw,fill=green!30] (C) at (9.75, 3) { $25$ };
            \node[circle,draw,fill=gray!30] (D) at (2.75, 1) { $5$ };
            \node[circle,draw,fill=gray!30] (E) at (5.75, 1) { $12$ };
            \node[circle,draw] (F) at (8.25, 1) { $20$ };
            \node[circle,draw] (G) at (11.25, 1) { $31$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            \node[anchor=west] (X) at (0, 6) { Travessia pré-ordem: 13, 10, 5, 1, 6, 12, 11, \textcolor{blue}{25} };
            \node[circle,draw,fill=gray!30] (A) at (6.75, 5) { $13$ };
            \node[circle,draw,fill=gray!30] (B) at (4.25, 3) { $10$ };
            \node[circle,draw,fill=blue!30] (C) at (9.75, 3) { $25$ };
            \node[circle,draw,fill=gray!30] (D) at (2.75, 1) { $5$ };
            \node[circle,draw,fill=gray!30] (E) at (5.75, 1) { $12$ };
            \node[circle,draw] (F) at (8.25, 1) { $20$ };
            \node[circle,draw] (G) at (11.25, 1) { $31$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            \node[anchor=west] (X) at (0, 6) { Travessia pré-ordem: 13, 10, 5, 1, 6, 12, 11, 25\textcolor{blue}{} };
            \node[circle,draw,fill=gray!30] (A) at (6.75, 5) { $13$ };
            \node[circle,draw,fill=gray!30] (B) at (4.25, 3) { $10$ };
            \node[circle,draw,fill=blue!30] (C) at (9.75, 3) { $25$ };
            \node[circle,draw,fill=gray!30] (D) at (2.75, 1) { $5$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            \node[anchor=west] (X) at (0, 6) { Travessia pré-ordem: 13, 10, 5, 1, 6, 12, 11, 25, \textcolor{blue}{20} };
            \node[circle,draw,fill=gray!30] (A) at (6.75, 5) { $13$ };
            \node[circle,draw,fill=gray!30] (B) at (4.25, 3) { $10$ };
            \node[circle,draw,fill=blue!30] (C) at (9.75, 3) { $25$ };
            \node[circle,draw,fill=gray!30] (D) at (2.75, 1) { $5$ };
            \node[circle,draw,fill=gray!30] (E) at (5.75, 1) { $12$ };
            \node[circle,draw,fill=blue!30] (F) at (8.25, 1) { $20$ };
            \node[circle,draw] (G) at (11.25, 1) { $31$ };
            \node[circle,draw,fill=gray!30] (H) at (2, -1) { $1$ };
            \node[circle,draw,fill=gray!30] (I) at (3.5, -1) { $6$ };
            \node[circle,draw,fill=gray!30] (J) at (5, -1) { $11$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            \node[anchor=west] (X) at (0, 6) { Travessia pré-ordem: 13, 10, 5, 1, 6, 12, 11, 25, 20 \textcolor{blue}{} };
            \node[circle,draw,fill=gray!30] (A) at (6.75, 5) { $13$ };
            \node[circle,draw,fill=gray!30] (B) at (4.25, 3) { $10$ };
            \node[circle,draw,fill=blue!30] (C) at (9.75, 3) { $25$ };
            \node[circle,draw,fill=gray!30] (D) at (2.75, 1) { $5$ };
            ...
            \node[circle,draw,fill=gray!30] (I) at (3.5, -1) { $6$ };
            \node[circle,draw,fill=gray!30] (J) at (5, -1) { $11$ };
            \node[circle,draw,fill=green!30] (L) at (7.5, -1) { $18$ };
            \node[circle,draw] (M) at (9, -1) { $22$ };
            \node[circle,draw] (N) at (10.5, -1) { $29$ };
            \node[circle,draw] (O) at (12, -1) { $45$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            \node[anchor=west] (X) at (0, 6) { Travessia pré-ordem: 13, 10, 5, 1, 6, 12, 11, 25, 20, \textcolor{blue}{18} };
            \node[circle,draw,fill=gray!30] (A) at (6.75, 5) { $13$ };
            \node[circle,draw,fill=gray!30] (B) at (4.25, 3) { $10$ };
            \node[circle,draw,fill=blue!30] (C) at (9.75, 3) { $25$ };
            \node[circle,draw,fill=gray!30] (D) at (2.75, 1) { $5$ };
            ...
            \node[circle,draw,fill=gray!30] (I) at (3.5, -1) { $6$ };
            \node[circle,draw,fill=gray!30] (J) at (5, -1) { $11$ };
            \node[circle,draw,fill=blue!30] (L) at (7.5, -1) { $18$ };
            \node[circle,draw] (M) at (9, -1) { $22$ };
            \node[circle,draw] (N) at (10.5, -1) { $29$ };
            \node[circle,draw] (O) at (12, -1) { $45$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            \node[anchor=west] (X) at (0, 6) { Travessia pré-ordem: 13, 10, 5, 1, 6, 12, 11, 25, 20, 18 \textcolor{blue}{} };
            \node[circle,draw,fill=gray!30] (A) at (6.75, 5) { $13$ };
            \node[circle,draw,fill=gray!30] (B) at (4.25, 3) { $10$ };
            \node[circle,draw,fill=blue!30] (C) at (9.75, 3) { $25$ };
            \node[circle,draw,fill=gray!30] (D) at (2.75, 1) { $5$ };
            ...
            \node[circle,draw,fill=gray!30] (I) at (3.5, -1) { $6$ };
            \node[circle,draw,fill=gray!30] (J) at (5, -1) { $11$ };
            \node[circle,draw,fill=gray!30] (L) at (7.5, -1) { $18$ };
            \node[circle,draw] (M) at (9, -1) { $22$ };
            \node[circle,draw] (N) at (10.5, -1) { $29$ };
            \node[circle,draw] (O) at (12, -1) { $45$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            ...
            \node[circle,draw,fill=gray!30] (D) at (2.75, 1) { $5$ };
            \node[circle,draw,fill=gray!30] (E) at (5.75, 1) { $12$ };
            \node[circle,draw,fill=red!30] (F) at (8.25, 1) { $20$ };
            \node[circle,draw] (G) at (11.25, 1) { $31$ };
            \node[circle,draw,fill=gray!30] (H) at (2, -1) { $1$ };
            \node[circle,draw,fill=gray!30] (I) at (3.5, -1) { $6$ };
            \node[circle,draw,fill=gray!30] (J) at (5, -1) { $11$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            \node[anchor=west] (X) at (0, 6) { Travessia pré-ordem: 13, 10, 5, 1, 6, 12, 11, 25, 20, 18, \textcolor{blue}{22} };
            \node[circle,draw,fill=gray!30] (A) at (6.75, 5) { $13$ };
            \node[circle,draw,fill=gray!30] (B) at (4.25, 3) { $10$ };
            \node[circle,draw,fill=blue!30] (C) at (9.75, 3) { $25$ };
            \node[circle,draw,fill=gray!30] (D) at (2.75, 1) { $5$ };
            ...
            \node[circle,draw,fill=gray!30] (J) at (5, -1) { $11$ };
            \node[circle,draw,fill=gray!30] (L) at (7.5, -1) { $18$ };
            \node[circle,draw,fill=blue!30] (M) at (9, -1) { $22$ };
            \node[circle,draw] (N) at (10.5, -1) { $29$ };
            \node[circle,draw] (O) at (12, -1) { $45$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            \node[anchor=west] (X) at (0, 6) { Travessia pré-ordem: 13, 10, 5, 1, 6, 12, 11, 25, 20, 18, 22 \textcolor{blue}{} };
            \node[circle,draw,fill=gray!30] (A) at (6.75, 5) { $13$ };
            \node[circle,draw,fill=gray!30] (B) at (4.25, 3) { $10$ };
            \node[circle,draw,fill=blue!30] (C) at (9.75, 3) { $25$ };
            \node[circle,draw,fill=gray!30] (D) at (2.75, 1) { $5$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            ...
            \node[circle,draw,fill=gray!30] (E) at (5.75, 1) { $12$ };
            \node[circle,draw,fill=gray!30] (F) at (8.25, 1) { $20$ };
            \node[circle,draw,fill=green!30] (G) at (11.25, 1) { $31$ };
            \node[circle,draw,fill=gray!30] (H) at (2, -1) { $1$ };
            \node[circle,draw,fill=gray!30] (I) at (3.5, -1) { $6$ };
            \node[circle,draw,fill=gray!30] (J) at (5, -1) { $11$ };
            \node[circle,draw,fill=gray!30] (L) at (7.5, -1) { $18$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            \node[anchor=west] (X) at (0, 6) { Travessia pré-ordem: 13, 10, 5, 1, 6, 12, 11, 25, 20, 18, 22, \textcolor{blue}{31} };
            \node[circle,draw,fill=gray!30] (A) at (6.75, 5) { $13$ };
            \node[circle,draw,fill=gray!30] (B) at (4.25, 3) { $10$ };
            \node[circle,draw,fill=gray!30] (C) at (9.75, 3) { $25$ };
            \node[circle,draw,fill=gray!30] (D) at (2.75, 1) { $5$ };
            \node[circle,draw,fill=gray!30] (E) at (5.75, 1) { $12$ };
            \node[circle,draw,fill=gray!30] (F) at (8.25, 1) { $20$ };
            \node[circle,draw,fill=blue!30] (G) at (11.25, 1) { $31$ };
            \node[circle,draw,fill=gray!30] (H) at (2, -1) { $1$ };
            \node[circle,draw,fill=gray!30] (I) at (3.5, -1) { $6$ };
            \node[circle,draw,fill=gray!30] (J) at (5, -1) { $11$ };
            \node[circle,draw,fill=gray!30] (L) at (7.5, -1) { $18$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            \node[anchor=west] (X) at (0, 6) { Travessia pré-ordem: 13, 10, 5, 1, 6, 12, 11, 25, 20, 18, 22, 31 \textcolor{blue}{} };
            \node[circle,draw,fill=gray!30] (A) at (6.75, 5) { $13$ };
            \node[circle,draw,fill=gray!30] (B) at (4.25, 3) { $10$ };
            \node[circle,draw,fill=gray!30] (C) at (9.75, 3) { $25$ };
            \node[circle,draw,fill=gray!30] (D) at (2.75, 1) { $5$ };
            ...
            \node[circle,draw,fill=gray!30] (L) at (7.5, -1) { $18$ };
            \node[circle,draw,fill=gray!30] (M) at (9, -1) { $22$ };
            \node[circle,draw,fill=green!30] (N) at (10.5, -1) { $29$ };
            \node[circle,draw] (O) at (12, -1) { $45$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            \node[anchor=west] (X) at (0, 6) { Travessia pré-ordem: 13, 10, 5, 1, 6, 12, 11, 25, 20, 18, 22, 31, \textcolor{blue}{29} };
            \node[circle,draw,fill=gray!30] (A) at (6.75, 5) { $13$ };
            \node[circle,draw,fill=gray!30] (B) at (4.25, 3) { $10$ };
            \node[circle,draw,fill=gray!30] (C) at (9.75, 3) { $25$ };
            \node[circle,draw,fill=gray!30] (D) at (2.75, 1) { $5$ };
            ...
            \node[circle,draw,fill=gray!30] (L) at (7.5, -1) { $18$ };
            \node[circle,draw,fill=gray!30] (M) at (9, -1) { $22$ };
            \node[circle,draw,fill=blue!30] (N) at (10.5, -1) { $29$ };
            \node[circle,draw] (O) at (12, -1) { $45$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            \node[anchor=west] (X) at (0, 6) { Travessia pré-ordem: 13, 10, 5, 1, 6, 12, 11, 25, 20, 18, 22, 31, 29 \textcolor{blue}{} };
            \node[circle,draw,fill=gray!30] (A) at (6.75, 5) { $13$ };
            \node[circle,draw,fill=gray!30] (B) at (4.25, 3) { $10$ };
            \node[circle,draw,fill=gray!30] (C) at (9.75, 3) { $25$ };
            \node[circle,draw,fill=gray!30] (D) at (2.75, 1) { $5$ };
            ...
            \node[circle,draw,fill=gray!30] (L) at (7.5, -1) { $18$ };
            \node[circle,draw,fill=gray!30] (M) at (9, -1) { $22$ };
            \node[circle,draw,fill=gray!30] (N) at (10.5, -1) { $29$ };
            \node[circle,draw] (O) at (12, -1) { $45$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            ...
            \node[circle,draw,fill=gray!30] (E) at (5.75, 1) { $12$ };
            \node[circle,draw,fill=gray!30] (F) at (8.25, 1) { $20$ };
            \node[circle,draw,fill=red!30] (G) at (11.25, 1) { $31$ };
            \node[circle,draw,fill=gray!30] (H) at (2, -1) { $1$ };
            \node[circle,draw,fill=gray!30] (I) at (3.5, -1) { $6$ };
            \node[circle,draw,fill=gray!30] (J) at (5, -1) { $11$ };
            \node[circle,draw,fill=gray!30] (L) at (7.5, -1) { $18$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            ...
            \node[circle,draw,fill=gray!30] (E) at (5.75, 1) { $12$ };
            \node[circle,draw,fill=gray!30] (F) at (8.25, 1) { $20$ };
            \node[circle,draw,fill=gray!30] (G) at (11.25, 1) { $31$ };
            \node[circle,draw,fill=gray!30] (H) at (2, -1) { $1$ };
            \node[circle,draw,fill=gray!30] (I) at (3.5, -1) { $6$ };
            \node[circle,draw,fill=gray!30] (J) at (5, -1) { $11$ };
            \node[circle,draw,fill=gray!30] (L) at (7.5, -1) { $18$ };
            \node[circle,draw,fill=gray!30] (M) at (9, -1) { $22$ };
            \node[circle,draw,fill=gray!30] (N) at (10.5, -1) { $29$ };
            \node[circle,draw,fill=green!30] (O) at (12, -1) { $45$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            \node[anchor=west] (X) at (0, 6) { Travessia pré-ordem: 13, 10, 5, 1, 6, 12, 11, 25, 20, 18, 22, 31, 29, \textcolor{blue}{45} };
            \node[circle,draw,fill=gray!30] (A) at (6.75, 5) { $13$ };
            \node[circle,draw,fill=gray!30] (B) at (4.25, 3) { $10$ };
            \node[circle,draw,fill=gray!30] (C) at (9.75, 3) { $25$ };
            \node[circle,draw,fill=gray!30] (D) at (2.75, 1) { $5$ };
            ...
            \node[circle,draw,fill=gray!30] (M) at (9, -1) { $22$ };
            \node[circle,draw,fill=gray!30] (N) at (10.5, -1) { $29$ };
            \node[circle,draw,fill=blue!30] (O) at (12, -1) { $45$ };
...
\begin{frame}[fragile]{Exemplo de travessia por profundidade}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            \node[anchor=west] (X) at (0, 6) { Travessia pré-ordem: 13, 10, 5, 1, 6, 12, 11, 25, 20, 18, 22, 31, 29, 45 \textcolor{blue}{} };
            \node[circle,draw,fill=gray!30] (A) at (6.75, 5) { $13$ };
            \node[circle,draw,fill=gray!30] (B) at (4.25, 3) { $10$ };
            \node[circle,draw,fill=gray!30] (C) at (9.75, 3) { $25$ };
            \node[circle,draw,fill=gray!30] (D) at (2.75, 1) { $5$ };
            ...
            \node[circle,draw,fill=gray!30] (M) at (9, -1) { $22$ };
            \node[circle,draw,fill=gray!30] (N) at (10.5, -1) { $29$ };
            \node[circle,draw,fill=gray!30] (O) at (12, -1) { $45$ };
...
\begin{frame}[fragile]{Implementação das travessias notáveis em C++}
    \inputsnippet{cpp}{1}{20}{codes/traversal.cpp}
\end{frame}

\begin{frame}[fragile]{Implementação das travessias notáveis em C++}
    \inputsnippet{cpp}{22}{41}{codes/traversal.cpp}
\end{frame}
...
\begin{frame}[fragile]{Reconstrução de árvores binárias a partir de travessias}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            \node[opacity=0,anchor=west] (X) at (0, 6) { Travessia pré-ordem: 13, 10, 5, 1, 6, 12, 11, 25, 20, 18, 22, 31, 29, 45 \textcolor{blue}{} };

            \node[circle,draw,fill=gray!30] (A) at (4, 5) { $1$ };
            \node[circle,draw,fill=gray!30] (B) at (5.5, 3) { $2$ };


            \node[circle,draw,fill=gray!30] (C) at (10, 5) { $2$ };
            \node[circle,draw,fill=gray!30] (D) at (8.5, 3) { $1$ };
