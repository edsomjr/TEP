...
\begin{frame}[fragile]{Solução com complexidade $O(NM\log MN)$}
...
\begin{frame}[fragile]{Solução com complexidade $O(NM\log NM)$}
    \inputsnippet{cpp}{1}{21}{12798.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(NM\log NM)$}
    \inputsnippet{cpp}{22}{39}{12798.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(NM\log NM)$}
    \inputsnippet{cpp}{40}{60}{12798.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(NM\log NM)$}
    \inputsnippet{cpp}{61}{79}{12798.cpp}
\end{frame}
...
\begin{frame}[fragile]{Solução com complexidade $O(NM)$}
    \inputsnippet{cpp}{1}{20}{12798_linear.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(NM)$}
    \inputsnippet{cpp}{21}{41}{12798_linear.cpp}
\end{frame}
