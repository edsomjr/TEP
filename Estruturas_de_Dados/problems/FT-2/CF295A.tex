...
\begin{frame}[fragile]{Solução com complexidade $O(N + (M + K)\log (M + K))$}
    \inputsnippet{cpp}{1}{21}{295A.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(N + (M + K)\log (M + K))$}
    \inputsnippet{cpp}{22}{41}{295A.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(N + (M + K)\log (M + K))$}
    \inputsnippet{cpp}{42}{62}{295A.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(N + (M + K)\log (M + K))$}
    \inputsnippet{cpp}{63}{83}{295A.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(N + (M + K)\log (M + K))$}
    \inputsnippet{cpp}{84}{104}{295A.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(N + (M + K)\log (M + K))$}
    \inputsnippet{cpp}{105}{125}{295A.cpp}
\end{frame}
