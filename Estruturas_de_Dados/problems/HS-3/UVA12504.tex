\section{UVA 12504 -- Updating the Dictionary}
...
\begin{frame}[fragile]{Solução com complexidade $O(TN)$}
    \inputsnippet{cpp}{1}{20}{12504.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(TN)$}
    \inputsnippet{cpp}{21}{41}{12504.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(TN)$}
    \inputsnippet{cpp}{42}{62}{12504.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(TN)$}
    \inputsnippet{cpp}{64}{84}{12504.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(TN)$}
    \inputsnippet{cpp}{85}{105}{12504.cpp}
\end{frame}
