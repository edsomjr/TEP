\section{OJ 12532 -- Interval Product}
...
\begin{frame}[fragile]{Solução com complexidade $O(T(N + K)\log(N + K))$}
    \inputsnippet{cpp}{1}{21}{codes/12532.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(T(N + K)\log(N + K))$}
    \inputsnippet{cpp}{22}{42}{codes/12532.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(T(N + K)\log(N + K))$}
    \inputsnippet{cpp}{43}{63}{codes/12532.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(T(N + K)\log(N + K))$}
    \inputsnippet{cpp}{64}{83}{codes/12532.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(T(N + K)\log(N + K))$}
    \inputsnippet{cpp}{84}{104}{codes/12532.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(T(N + K)\log(N + K))$}
    \inputsnippet{cpp}{105}{125}{codes/12532.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(T(N + K)\log(N + K))$}
    \inputsnippet{cpp}{126}{146}{codes/12532.cpp}
\end{frame}
