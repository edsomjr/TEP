...
\begin{frame}[fragile]{Solução AC com complexidade $O(TN\log M)$}
    \inputsnippet{cpp}{1}{20}{codes/INVCNT.cpp}
\end{frame}

\begin{frame}[fragile]{Solução AC com complexidade $O(TN\log M)$}
    \inputsnippet{cpp}{21}{41}{codes/INVCNT.cpp}
\end{frame}

\begin{frame}[fragile]{Solução AC com complexidade $O(TN\log M)$}
    \inputsnippet{cpp}{42}{62}{codes/INVCNT.cpp}
\end{frame}

\begin{frame}[fragile]{Solução AC com complexidade $O(TN\log M)$}
    \inputsnippet{cpp}{63}{83}{codes/INVCNT.cpp}
\end{frame}

\begin{frame}[fragile]{Solução AC com complexidade $O(TN\log M)$}
    \inputsnippet{cpp}{84}{104}{codes/INVCNT.cpp}
\end{frame}
