...
\begin{frame}[fragile]{Solução com complexidade $O(N^2)$}
    \inputsnippet{cpp}{1}{17}{URI1466.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(N^2)$}
    \inputsnippet{cpp}{18}{38}{URI1466.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(N^2)$}
    \inputsnippet{cpp}{39}{57}{URI1466.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(N^2)$}
    \inputsnippet{cpp}{58}{78}{URI1466.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(N^2)$}
        \inputsnippet{cpp}{79}{99}{URI1466.cpp}
\end{frame}
