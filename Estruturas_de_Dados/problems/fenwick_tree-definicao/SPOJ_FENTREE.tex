...
\begin{frame}[fragile]{Solução AC com complexidade $O((Q + N)\log N)$}
    \inputsnippet{cpp}{1}{21}{codes/FENTREE.cpp}
\end{frame}

\begin{frame}[fragile]{Solução AC com complexidade $O((Q + N)\log N)$}
    \inputsnippet{cpp}{22}{41}{codes/FENTREE.cpp}
\end{frame}

\begin{frame}[fragile]{Solução AC com complexidade $O((Q + N)\log N)$}
    \inputsnippet{cpp}{42}{61}{codes/FENTREE.cpp}
\end{frame}

\begin{frame}[fragile]{Solução AC com complexidade $O((Q + N)\log N)$}
    \inputsnippet{cpp}{62}{82}{codes/FENTREE.cpp}
\end{frame}
