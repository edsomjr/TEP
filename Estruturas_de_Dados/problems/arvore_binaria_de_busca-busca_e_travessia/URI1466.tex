\section{URI 1466 -- Percurso em Árvore por Nível}
...
\begin{frame}[fragile]{Solução com complexidade $O(N^2)$}
    \inputsnippet{cpp}{1}{17}{codes/URI1466.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(N^2)$}
    \inputsnippet{cpp}{18}{38}{codes/URI1466.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(N^2)$}
    \inputsnippet{cpp}{39}{57}{codes/URI1466.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(N^2)$}
    \inputsnippet{cpp}{58}{78}{codes/URI1466.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(N^2)$}
        \inputsnippet{cpp}{79}{99}{codes/URI1466.cpp}
\end{frame}
