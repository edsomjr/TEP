...
\begin{frame}[fragile]{Solução com complexidade $O(T(N + K)\log(N + K))$}
    \inputsnippet{cpp}{1}{20}{codes/12532.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(T(N + K)\log(N + K))$}
    \inputsnippet{cpp}{22}{41}{codes/12532.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(T(N + K)\log(N + K))$}
    \inputsnippet{cpp}{43}{62}{codes/12532.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(T(N + K)\log(N + K))$}
    \inputsnippet{cpp}{64}{81}{codes/12532.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(T(N + K)\log(N + K))$}
    \inputsnippet{cpp}{83}{102}{codes/12532.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(T(N + K)\log(N + K))$}
    \inputsnippet{cpp}{104}{122}{codes/12532.cpp}
\end{frame}

\begin{frame}[fragile]{Solução com complexidade $O(T(N + K)\log(N + K))$}
    \inputsnippet{cpp}{124}{146}{codes/12532.cpp}
\end{frame}
