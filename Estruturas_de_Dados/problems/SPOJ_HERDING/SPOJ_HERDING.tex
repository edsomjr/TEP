...
\begin{frame}[fragile]{Solução AC com complexidade $O(MN\log MN)$}
    \inputsnippet{cpp}{1}{20}{codes/HERDING.cpp}
\end{frame}

\begin{frame}[fragile]{Solução AC com complexidade $O(MN\log MN)$}
    \inputsnippet{cpp}{22}{41}{codes/HERDING.cpp}
\end{frame}

\begin{frame}[fragile]{Solução AC com complexidade $O(MN\log MN)$}
    \inputsnippet{cpp}{43}{62}{codes/HERDING.cpp}
\end{frame}

\begin{frame}[fragile]{Solução AC com complexidade $O(MN\log MN)$}
    \inputsnippet{cpp}{65}{81}{codes/HERDING.cpp}
\end{frame}

\begin{frame}[fragile]{Solução AC com complexidade $O(MN\log MN)$}
    \inputsnippet{cpp}{83}{107}{codes/HERDING.cpp}
\end{frame}
