...
o volume pode ser determinado através do módulo dod produto misto 
`V = |<A x B, C>|`, onde
...
`m, n, p` formados entre eleas, é possível computar o volume do paralelogramo
...
O cilíndro é uma figura geométrica formada pelos pontos equidistantes de um
...
A área lateral do cilíndro é dada por `A = 2*PI*r*h + 2*PI*r*r = 2*PI*r*(h + r)`,
...
<!--- inserir texto sobre interseção de cilíndros e planos -->
