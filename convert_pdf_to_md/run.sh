...
#exemplo de utilização: bash run.sh SSP2.pdf 4 13 22 djikstra
...
python3 txt_2md.py test.txt $foldername/ $first_parse_page $last_parse_page $last_page_file > $foldername/$foldername.md
rm -rf *.txt
